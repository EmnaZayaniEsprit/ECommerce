...
namespace ECmmerce.Data.Infrastructure
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        {
            get { return addressRepository = new AddressRepository(dbFactory); }
        }
        ...
        {
            get { return commisionRepository = new CommisionRepository(dbFactory); }
        }

        private ICreditCardRepository creditCardRepository;
        public ICreditCardRepository CreditCardRepository
        {
            get { return creditCardRepository = new CreditCardRepository(dbFactory); }
        }
        ...
        {
            get { return gouvernoratRepository = new GouvernoratRepository(dbFactory); }
        }

        private IOrderItemRepository orderItemRepository;
        public IOrderItemRepository OrderItemRepository
        {
            get { return orderItemRepository = new OrderItemRepository(dbFactory); }
        }
        ...
        {
            get { return pictureRepository = new PictureRepository(dbFactory); }
        }

        private IProductItemRepository productItemRepository;
        public IProductItemRepository ProductItemRepository
        {
            get { return productItemRepository = new ProductItemRepository(dbFactory); }
        }
        ...
        {
            get { return productItemSupplierRepository = new ProductItemSupplierRepository(dbFactory); }
        }
        ...
        {
            get { return reclamationRepository = new ReclamationRepository(dbFactory); }
        }

        private IReviewRepository reviewRepository;
        public IReviewRepository ReviewRepository
        {
            get { return reviewRepository = new ReviewRepository(dbFactory); }
        }
        ...
        {
            get { return recommendationRepository = new RecommendationRepository(dbFactory); }
        }

        private IShoppingCartRepository shoppingCartRepository;
        public IShoppingCartRepository ShoppingCartRepository
        {
            get { return shoppingCartRepository = new ShoppingCartRepository(dbFactory); }
